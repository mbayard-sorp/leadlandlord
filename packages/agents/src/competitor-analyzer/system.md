...
### content_gaps
Topics competitors address thinly (one or two mentions) or omit entirely. These are differentiation targets for the tenant. Minimum 3, maximum 10. Express as topic labels, not sentences. Never copy competitor phrasing.
