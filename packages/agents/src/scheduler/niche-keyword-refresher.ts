...
// Jan/Apr/Jul/Oct; the month-step expands to 1,4,7,10). Dedupe key is
// quarter-scoped so duplicate cron ticks are queue-level no-ops, and
// BaseAgent's run dedupe (same key) makes a re-dispatched event a cached
// no-op too.
