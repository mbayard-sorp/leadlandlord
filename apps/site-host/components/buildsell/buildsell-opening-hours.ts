/**
 * Pure free-text hours parser for <BuildSellLocalBusinessJsonLd>. Kept out of
 * the component file (and importing only relative modules, no path alias) so
 * it's unit-testable without a React/JSX transform — mirrors
 * components/shared/local-business-schema.ts.
 */
 ...
 */
export function parseOpeningHours(hours: string): OpeningHoursEntry[] {
